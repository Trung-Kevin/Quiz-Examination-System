...
LRESULT CALLBACK FormWindowProc(
    HWND hwnd,
    UINT msg,
    WPARAM wParam,
    LPARAM lParam)
    ...
    LPARAM lParam)
{
    ...
    case WM_COMMAND:
    {
            ...
            id < ID_DASH_BASE + 20)
        {
            ...
            // QUAN TRỌNG:
            // Đóng if (id >= ID_DASH_BASE...)
            return 0;
        }

        // QUAN TRỌNG:
        // Đóng case WM_COMMAND
        return 0;
    }
